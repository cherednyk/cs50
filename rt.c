...
int main(int argc, char* argv[])
{
    ...
    BITMAPFILEHEADER bf;
    fread(&bf, sizeof(BITMAPFILEHEADER), 1, inptr);  //  !!!!   find out how fread works  !!!   !!!   !!!
    ...
    // prepare increased size for new image
    bi2.biSizeImage = (bi2.biWidth * sizeof(RGBTRIPLE) + padding)  * abs(bi2.biHeight);
    
    BITMAPFILEHEADER bf2 = bf;
    
    // prepare increased size for new file
    bf2.bfSize = bi2.biSizeImage + 54; 

    // write outfile's BITMAPFILEHEADER
    fwrite(&bf2, sizeof(BITMAPFILEHEADER), 1, outptr);   //  !!!!   find out how fwrite works !!!   !!!   !!!
    ...
    for (int i = 0, biHeight = abs(bi2.biHeight); i < biHeight; i++)   //  !!!!   start from here !!!   !!!   !!!
    {
